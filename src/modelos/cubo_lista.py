...
#     def get_cara(self, cara: Cara) -> list[list[Etiqueta]]:
...
#     """
#     return Cubo(
#         u = copy.deepcopy(cubo.get_cara(Cara.U)),
#         d = copy.deepcopy(cubo.get_cara(Cara.D)),
#         f = copy.deepcopy(cubo.get_cara(Cara.F)),
#         b = copy.deepcopy(cubo.get_cara(Cara.B)),
#         r = copy.deepcopy(cubo.get_cara(Cara.R)),
#         l = copy.deepcopy(cubo.get_cara(Cara.L)),
#     )
...
#     girado = np.fliplr(numpy_matriz.transpose())
#     return list(girado)


# def _girar_matriz_antihorario(matriz: list[list]):
#     numpy_matriz = np.array(matriz)
#     girado = np.flipud(numpy_matriz.transpose())
#     return list(girado)


# def _cotar_horizontalmente_horario(cubo: Cubo, fila: int) -> dict[str, list[list]]:
#     """
...
# def _cotar_horizontalmente_antihorario(cubo: Cubo, fila: int) -> dict[str, list[list]]:
#     """
...
# def _cotar_horizontalmente(cubo: Cubo, fila: int, horario: bool) -> dict[str, list[list]]:
#     """
